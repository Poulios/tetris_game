...
pauseButton = button((0, 255, 0), top_left_x - 170, top_left_y + 220, 70, 35, "Pause")
quitButton = button((0, 255, 0), top_left_x - 170, top_left_y + 150, 70, 35, "Quit")
pause = 1


def redrawWindow(surface, var):
    # win.fill((255,255,255))
    pauseButton = button((0, 255, 0), top_left_x - 170, top_left_y + 220, 70, 35, "Pause")
    # quitButton = button((0, 255, 0), top_left_x - 170, top_left_y + 150, 70, 35, "Quit")

    if var == pause:
        pauseButton = button((0, 255, 0), top_left_x - 170, top_left_y + 220, 70, 35, "Play")
    pauseButton.draw(surface, (0, 0, 0))
...
def main():
    ...
    while run:
        ...
        if state == running:
            ...
            draw_text_middle('PAUSE', 60, (255, 255, 255), win)
            pygame.display.update()
            redrawWindow(win, state)
            pygame.display.update()
...
win.fill((0, 0, 0))
draw_text_middle('Play through keyboard arrows, select Pause, Play, Quit by pressing P, U, Q keys or the screen Buttons', 20, (255, 255, 255), win)
pygame.display.update()
time.sleep(4.5)
